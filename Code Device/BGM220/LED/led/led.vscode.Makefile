...
ifeq ($(OS),Windows_NT)
	POSIX_TOOL_PATH := H:/Si/support/common/build/msys/1.0/bin/
endif
TOOLCHAIN_DIR := H:/Si/developer/toolchains/gnu_arm/10.3_2021.10
SDK_PATH := C:/Users/hieu2/SimplicityStudio/SDKs/gecko_sdk

ARM_GCC_DIR_WIN = H:/Si/developer/toolchains/gnu_arm/10.3_2021.10
ARM_GCC_DIR_OSX = 
ARM_GCC_DIR_LINUX = 
POST_BUILD_EXE_WIN = H:/Si/developer/adapter_packs/commander/commander.exe
POST_BUILD_EXE_OSX = 
...
-include led.vscode.project.mak


ASM_INCLUDES := -I"config" -I"autogen" -I"." -I"$(SDK_PATH)/platform/Device/SiliconLabs/BGM22/Include" -I"$(SDK_PATH)/platform/CMSIS/Core/Include" -I"$(SDK_PATH)/platform/service/device_init/inc" -I"$(SDK_PATH)/platform/emlib/inc" -I"$(SDK_PATH)/platform/common/inc" -I"$(SDK_PATH)/platform/common/toolchain/inc" -I"$(SDK_PATH)/platform/service/system/inc" 
C_INCLUDES := -I"config" -I"autogen" -I"." -I"$(SDK_PATH)/platform/Device/SiliconLabs/BGM22/Include" -I"$(SDK_PATH)/platform/CMSIS/Core/Include" -I"$(SDK_PATH)/platform/service/device_init/inc" -I"$(SDK_PATH)/platform/emlib/inc" -I"$(SDK_PATH)/platform/common/inc" -I"$(SDK_PATH)/platform/common/toolchain/inc" -I"$(SDK_PATH)/platform/service/system/inc" 
CXX_INCLUDES := -I"config" -I"autogen" -I"." -I"$(SDK_PATH)/platform/Device/SiliconLabs/BGM22/Include" -I"$(SDK_PATH)/platform/CMSIS/Core/Include" -I"$(SDK_PATH)/platform/service/device_init/inc" -I"$(SDK_PATH)/platform/emlib/inc" -I"$(SDK_PATH)/platform/common/inc" -I"$(SDK_PATH)/platform/common/toolchain/inc" -I"$(SDK_PATH)/platform/service/system/inc" 
